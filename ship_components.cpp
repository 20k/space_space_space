...
void component::manufacture_blueprint_id_rpc(size_t blue_id)
{
    rpc("manufacture_blueprint_id", *this, blue_id);
}

void component::transfer_stored_from_to_rpc(size_t pid_ship_from, size_t pid_component_to)
{
    rpc("transfer_store_from_to", *this, pid_ship_from, pid_component_to);
}

void component::transfer_stored_from_to_frac_rpc(size_t pid_ship_from, size_t pid_component_to, float frac)
{
    rpc("transfer_stored_from_to_frac", *this, pid_ship_from, pid_component_to, frac);
}
